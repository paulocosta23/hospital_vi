...
COLOR_THEME = {
    LIGHT: {
        "menu_text":            "#0F172A",   # preto legível no menu claro
        "bg":                   "#EEF2F9",   # azul-aço suave, sem brancão
        "panel":                "#E2E8F2",
        "surface":              "#F8FAFF",
        "surface_alt":          "#E6EDF7",
        "surface_dark":         "#D4DDED",
        "sidebar":              "#DDE5F2",   # slate-azulado elegante
        "topbar":               "#C9D8EF",   # azul-aço médio
        "card":                 "#FFFFFF",
        "border":               "#BFC9DB",
        "text":                 "#0F172A",
        "text_secondary":       "#3D5068",
        "text_muted":           "#64748B",
        "accent":               "#2563EB",
        "accent_hover":         "#1D4ED8",
        "button":               "#2563EB",
